...
"""
plt.plot(temp1_20x20[1], temp1_20x20[4] , label = "<M>",marker ="x")
plt.plot(temp1_20x20[1], temp1_20x20[5] , label = "<|M|>")#,marker ="o")
plt.plot(temp24_20x20[1], temp24_20x20[4] , label = "<M>",marker ="x")
plt.plot(temp24_20x20[1], temp24_20x20[5] , label = "<|M|>")#,marker ="o")
